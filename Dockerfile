...
RUN wget https://bootstrap.pypa.io/get-pip.py && python3 get-pip.py && pip3 install opencv-python==4.2.0.32 && pip3 install numpy && pip3 install torchvision && pip3 install scipy
